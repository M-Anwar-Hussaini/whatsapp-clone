...
mixin _$ChatModel {
 ...
 String get name; String get icon; bool get isGroup;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChatModel&&(identical(other.name, name) || other.name == name)&&(identical(other.icon, icon) || other.icon == icon)&&(identical(other.isGroup, isGroup) || other.isGroup == isGroup));
}


@override
int get hashCode => Object.hash(runtimeType,name,icon,isGroup);

@override
String toString() {
  return 'ChatModel(name: $name, icon: $icon, isGroup: $isGroup)';
}
...
@useResult
$Res call({
 String name, String icon, bool isGroup
});
...
/// Create a copy of ChatModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? icon = null,Object? isGroup = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String icon,  bool isGroup)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChatModel() when $default != null:
return $default(_that.name,_that.icon,_that.isGroup);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String icon,  bool isGroup)  $default,) {final _that = this;
switch (_that) {
case _ChatModel():
return $default(_that.name,_that.icon,_that.isGroup);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String icon,  bool isGroup)?  $default,) {final _that = this;
switch (_that) {
case _ChatModel() when $default != null:
return $default(_that.name,_that.icon,_that.isGroup);case _:
  return null;
...
class _ChatModel implements ChatModel {
  const _ChatModel({required this.name, required this.icon, this.isGroup = false});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChatModel&&(identical(other.name, name) || other.name == name)&&(identical(other.icon, icon) || other.icon == icon)&&(identical(other.isGroup, isGroup) || other.isGroup == isGroup));
}
...
/// Create a copy of ChatModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? icon = null,Object? isGroup = null,}) {
